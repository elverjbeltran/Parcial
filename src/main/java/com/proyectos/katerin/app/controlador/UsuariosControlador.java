package com.proyectos.katerin.app.controlador;
...
import com.proyectos.katerin.app.repository.UsuariosRepository;
...
public class UsuariosControlador {
    ...
    public String verificarCredenciales(@RequestParam("usuario") String usuario, @RequestParam("contrasena") String contrasena) {
    ...
    public String verificarCredencialesDirector(@RequestParam("usuario") String usuario, @RequestParam("contrasena") String contrasena) {
    ...
    public String verificarCredencialesEst(@RequestParam("usuario") String usuario, @RequestParam("contrasena") String contrasena) {
    ...
    public String verificarCredencialesEv(@RequestParam("usuario") String usuario, @RequestParam("contrasena") String contrasena) {
    ...
    public String verificarCredencialesCoor(@RequestParam("usuario") String usuario, @RequestParam("contrasena") String contrasena) {
