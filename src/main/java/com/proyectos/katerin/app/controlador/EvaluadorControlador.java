...
import com.proyectos.katerin.app.repository.AnteproyectosAprobRepository;
import com.proyectos.katerin.app.repository.DocentesRepository;
import com.proyectos.katerin.app.repository.EvaluadorRepository;
import com.proyectos.katerin.app.variables.Anteproyectos_Aprobados;
import com.proyectos.katerin.app.variables.Docente;
import com.proyectos.katerin.app.variables.Evaluador;
...
public class EvaluadorControlador {
    ...
    public String asignarEvaluadorProcesar(@RequestParam("proyectoTitulo") String proyectoTitulo, @RequestParam("evaluador") String evaluadorId) {
